...
namespace Monopoly_Project
{
    public partial class Trade_Screen : Form
    {
        ...
        string[] thisPlayerWantToTradeProperties;
        int countChoice;
        ...
        public Trade_Screen(int receiverPlayerNo, string playerToTradeWithID, string playerWantToTradeID,  Image playerToTradeWithIcon, 
                            Image playerWantToTradeIcon, List<string> requestedProperties, string[] playerWantToTradeProperties)
        {
            InitializeComponent();
            // Set things
            ...
            for(int i = 0; i < thisPlayerWantToTradeProperties.Length; i++)
            {
