...
namespace Monopoly_Project
{
    ...
    public partial class ShowPropertiesScreen : Form
    {
        ...
        int thisPlayerNO;
        int countChoice;
        public ShowPropertiesScreen(string[] properties, int playerNO, string playerID, Image toShow)
        {
            InitializeComponent();
        ...
        {
            // DATABASELE SEÇİLECEK BUNLAR AMA NASIL OLCAKKK Kİİİİ???????********??***
            if(sendTradeReqButton.Text == "Send Trade Request")
            {
                string[] denemelikArr = {"gdynia","taipei","grandCentral","tokyo","barcelona","athens",
                ...
                using (Trade_Screen tradeScreen = new Trade_Screen(thisPlayerNO,"batu", "deniz",player_icon_show_prop.Image,player_icon_show_prop.Image,choosedProperties,denemelikArr))
                {
